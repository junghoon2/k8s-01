...
{{- $colocatedLookupByPod := include "k10.colocatedServiceLookup" . | fromYaml }}
...
{{- $podService := .k10_service_pod }}
{{- $containerList := (dict "main" . "k10_service_pod" $podService | include "get.serviceContainersInPod" | splitList " ") }}
