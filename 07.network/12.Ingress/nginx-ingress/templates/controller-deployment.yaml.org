...
{{- end }}
        ...
        # diamanti.com/endpoint0: '{"endpointId":"nginx-ing-ep1","perfTier":"high"}'     
...
{{- end }}
          ...
          # - -udp-services-configmap=${POD_NAMESPACE}/jvb-udp-svc
          # hel- -tcp-services-configmap=${POD_NAMESPACE}/tcp-services
{{- end }}
