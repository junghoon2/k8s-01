...
{{- define "k10.restServices" -}}auth bloblifecyclemanager catalog crypto dashboardbff executor jobs logging metering state {{- end -}}
{{- define "k10.services" -}}aggregatedapis config {{- end -}}
{{- define "k10.statelessServices" -}}aggregatedapis auth bloblifecyclemanager crypto dashboardbff executor state {{- end -}}
